...
// import { E_TaskType, T_Task } from '@/app-types';
...
export const TaskDropDown: React.FC<T_Props> = ({ onOpen, onClose }) => {
  ...
  //     const validLabels: E_TaskType[] = ['Bug', 'Documentation', 'Feature'];
  //     if (!validLabels.includes(newLabel as E_TaskType)) {
